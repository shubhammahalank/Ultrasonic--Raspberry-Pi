...
smtp_username = "raspberrypi357@gmail.com" # This is the username used to login to your SMTP provider
smtp_password = "bvbcetreu" # This is the password used to login to your SMTP provider
smtp_host = "www.gmail.com" # This is the host of the SMTP provider
smtp_port = 25 # This is the port that your SMTP provider uses

smtp_sender = "raspberrypi357@gmail.com" # This is the FROM email address
smtp_receivers = ['shubhammahalank@gmail.com'] # This is the TO email address

# The next two variables use triple quotes, these allow us to preserve the line breaks in the string. 

# This is the message that will be sent when NO traffic is detected

message_dead = """From: Sender Name <sender@email.com>
To: Receiver Name <receiver@email.com>
Subject: Traffic Density Notification
Warning, no Traffic detected! Proceed Ahead!!!
"""

# This is the message that will be sent when traffic IS detected again

message_alive = """From: Sender Name <sender@email.com>
To: Receiver Name <receiver@email.com>
Subject: Traffic Density Notification
Traffic Detected, Please Change Direction:)
"""
